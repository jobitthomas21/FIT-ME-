...
public class viewpost extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ListView list;
    SharedPreferences sh;
    String ip, url,url1, lid;

    String[] pid, post, pdate;
...
//                        Toast.makeText(getApplicationContext(), response, Toast.LENGTH_LONG).show();
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                list.setAdapter(new custompost(getApplicationContext(), pid, post, pdate));//custom_view_service.xml and li is the listview object
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        switch (which) {
                            ...
                            {
                                Intent i =new Intent(getApplicationContext(),View_own_post.class);
                                i.putExtra("pid",id);
                                startActivity(i);
//                                requestQueue.add(postRequest);
                            }
